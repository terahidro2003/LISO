            ...
            <div class="card login-card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ url('/register') }}">
                        ...
                        <div class="form-group row">
                              <label for="email" class="col-md-12 col-form-label text-md-left">Vardas, pavardė</label>

                              <div class="col-md-12">
                                  <input id="code" type="text" class="form-control{{ $errors->has('code') ? ' is-invalid' : '' }}" name="name" value="{{ old('name') }}" required autofocus>
